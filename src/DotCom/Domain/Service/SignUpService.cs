...
namespace OwnApt.DotCom.Domain.Service
{
    public class SignUpService : ISignUpService
    {
        ...
        public async Task<string> CreateTokenAsync(params string[] propertyIds)
        {
            ...
            var base64TokenBytes = Encoding.UTF8.GetBytes(base64Token);
            var protectedBytes = this.dataProtector.Protect(base64TokenBytes);
        ...
        public async Task<SignUpTokenDto> ParseTokenAsync(string token)
        {
            ...
            var base64TokenBytes = this.dataProtector.Unprotect(protectedBytes);
            var base64Token = Encoding.UTF8.GetString(base64TokenBytes);
